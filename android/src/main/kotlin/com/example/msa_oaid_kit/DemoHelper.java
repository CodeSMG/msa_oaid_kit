...
public class DemoHelper implements IIdentifierListener {
    ...
    public static final String ASSET_FILE_NAME_CERT = "com.xxhbox.app.cert.pem";  // TODO （2）设置 asset证书文件名
...
//            onSupport(unsupportedIdSupplier);
    ...
    public interface AppIdsUpdater {
        ...
        void onIdsError(int errorCode,String err);
    }
